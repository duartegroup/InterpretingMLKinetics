#  Original script from https://github.com/cimm-kzn/CGRtools.git
#  Modified in the current work to allow for SMILES with repeat ring closure numbers to be parsed
#  Used in converting SMILES to rdf 
